...
const api: OldfolioDesktopApi = {
  ...
  syncYouTubeCreatorHistory: (id) => ipcRenderer.invoke('creator:sync-youtube-history', id),
  ...
  prepareLocalMediaBatch: () => ipcRenderer.invoke('media:prepare-local-batch'),
  startLocalMediaBatch: (input) => ipcRenderer.invoke('media:start-local-batch', input),
  ...
  cancelMediaJob: (jobId) => ipcRenderer.invoke('media:cancel-job', jobId),
